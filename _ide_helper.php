 ...
 * Generated for Laravel 5.7.11 on 2018-10-25 16:38:33.
 *
...
namespace App\Facades { 
    ...
    class ShutterStock {
         ...
         * 
         *
         * @param \App\ShutterStock\RequestInterface $request
         * @return \App\ShutterStock\ResponseInterface 
         * @throws \App\ShutterStock\ClientException
         * @static 
         */ 
        public static function sendRequest($request)
        {
            return \App\ShutterStock\Client::sendRequest($request);
        }
...
namespace  { 
    ...
    class ShutterStock extends \App\Facades\ShutterStock {}
